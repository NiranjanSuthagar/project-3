...
const {
  VITE_REACT_APP_CONTENTSTACK_API_HOST,
  VITE_REACT_APP_CONTENTSTACK_API_KEY,
  VITE_REACT_APP_CONTENTSTACK_APP_HOST,
} = import.meta.env;
const customHostBaseUrl = VITE_REACT_APP_CONTENTSTACK_API_HOST? customHostUrl(
  VITE_REACT_APP_CONTENTSTACK_API_HOST as string
): "";
// SDK initialization
...
ContentstackLivePreview.init({
  ...
  stackSdk: Stack,
  clientUrlParams:{
    host: VITE_REACT_APP_CONTENTSTACK_APP_HOST
  }
